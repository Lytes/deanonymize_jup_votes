export type JupVote = {
  ...
  constants: [
    { name: "MAX_OPTION"; type: "u8"; value: "10" },
    { name: "ABSTAIN_VOTE_INDEX"; type: { defined: "usize" }; value: "0" },
    { name: "AGAINST_VOTE_INDEX"; type: { defined: "usize" }; value: "1" },
    { name: "FOR_VOTE_INDEX"; type: { defined: "usize" }; value: "2" }
  ];
  instructions: [
    {
      name: "createGovernor";
      ...
      accounts: [
        ...
        { name: "governor"; isMut: true; isSigner: false; docs: ["Governor."] },
        {
          name: "smartWallet";
          isMut: false;
          isSigner: false;
      ...
      args: [
        ...
        { name: "params"; type: { defined: "GovernanceParameters" } }
      ];
    },
    {
      name: "createProposal";
      ...
      args: [
        { name: "proposalType"; type: "u8" },
        { name: "maxOption"; type: "u8" },
        {
          name: "instructions";
          type: { vec: { defined: "ProposalInstruction" } };
        }
      ];
    },
    {
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "vote"; isMut: true; isSigner: false; docs: ["The vote."] },
        {
          name: "payer";
          isMut: true;
          isSigner: true;
      ...
      args: [{ name: "voter"; type: "publicKey" }];
    },
    {
      name: "setVote";
      docs: [
      ...
      args: [{ name: "side"; type: "u8" }, { name: "weight"; type: "u64" }];
    },
    {
      ...
      args: [{ name: "params"; type: { defined: "GovernanceParameters" } }];
    },
    {
      ...
      args: [{ name: "rewardPerProposal"; type: "u64" }];
    },
    {
      name: "claimReward";
      ...
      accounts: [
        ...
        { name: "proposal"; isMut: true; isSigner: false; docs: ["proposal"] },
        { name: "vote"; isMut: true; isSigner: false; docs: ["The [Vote]."] },
        {
          name: "voter";
          isMut: false;
    ...
    },
    {
      ...
      args: [{ name: "newLocker"; type: "publicKey" }];
    },
    {
      ...
      args: [
        ...
        { name: "descriptionLink"; type: "string" }
      ];
    },
    {
      ...
      args: [
        { name: "bump"; type: "u8" },
        { name: "optionDescriptions"; type: { vec: "string" } }
      ];
    }
  ];
  accounts: [
    {
      ...
      type: {
        kind: "struct";
        fields: [
          { name: "base"; docs: ["Base."]; type: "publicKey" },
          ...
          },
          {
            ...
            type: { defined: "GovernanceParameters" };
          },
          {
            name: "votingReward";
            docs: ["optional reward, can set by smartwallet"];
            type: { defined: "VotingReward" };
          },
          {
            name: "buffers";
    ...
    },
    {
      ...
      type: {
        kind: "struct";
        fields: [
          { name: "proposal"; docs: ["The [Proposal]."]; type: "publicKey" },
          { name: "title"; docs: ["Title of the proposal."]; type: "string" },
          {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "voter"; docs: ["The voter."]; type: "publicKey" },
          { name: "bump"; docs: ["Bump seed"]; type: "u8" },
          { name: "side"; docs: ["The side of the vote taken."]; type: "u8" },
          {
            name: "votingPower";
  ...
  types: [
    {
      ...
      type: {
        kind: "struct";
        fields: [
          { name: "rewardMint"; docs: ["Reward mint"]; type: "publicKey" },
          { name: "rewardVault"; docs: ["Reward vault"]; type: "publicKey" },
          {
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            type: { vec: { defined: "ProposalAccountMeta" } };
          },
          {
            name: "data";
    ...
    },
    {
      name: "ProposalType";
      docs: ["Proposal type"];
      type: { kind: "enum"; variants: [{ name: "YesNo" }, { name: "Option" }] };
    }
  ];
  events: [
    {
      ...
      fields: [
        ...
        { name: "proposal"; type: "publicKey"; index: false },
        { name: "votingEndsAt"; type: "i64"; index: false }
      ];
    },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "proposal"; type: "publicKey"; index: false },
        { name: "votingReward"; type: "u64"; index: false }
      ];
    },
    {
      ...
      fields: [
        ...
        { name: "smartWallet"; type: "publicKey"; index: false },
        {
          name: "parameters";
          type: { defined: "GovernanceParameters" };
          index: false;
    ...
    },
    {
      ...
      fields: [
        { name: "governor"; type: "publicKey"; index: false },
        { name: "proposal"; type: "publicKey"; index: false },
        { name: "optionDescriptions"; type: { vec: "string" }; index: false }
      ];
    },
    {
      ...
      fields: [
        ...
        { name: "descriptionLink"; type: "string"; index: false }
      ];
    },
    {
      ...
      fields: [
        ...
        { name: "proposalType"; type: "u8"; index: false },
        { name: "maxOption"; type: "u8"; index: false },
        { name: "index"; type: "u64"; index: false },
        {
          name: "instructions";
          type: { vec: { defined: "ProposalInstruction" } };
          index: false;
    ...
    },
    {
      ...
      fields: [
        { name: "governor"; type: "publicKey"; index: false },
        { name: "proposal"; type: "publicKey"; index: false },
        { name: "transaction"; type: "publicKey"; index: false }
      ];
    },
    {
    ...
    },
    {
      ...
      fields: [
        { name: "governor"; type: "publicKey"; index: false },
        { name: "prevLocker"; type: "publicKey"; index: false },
        { name: "newLocker"; type: "publicKey"; index: false }
      ];
    },
    {
      name: "VoteSetEvent";
      fields: [
        ...
        { name: "proposal"; type: "publicKey"; index: false },
        { name: "voter"; type: "publicKey"; index: false },
        { name: "vote"; type: "publicKey"; index: false },
        { name: "side"; type: "u8"; index: false },
        { name: "votingPower"; type: "u64"; index: false }
      ];
    },
    {
      ...
      fields: [
        ...
        { name: "rewardPerProposal"; type: "u64"; index: false }
      ];
    }
  ];
  errors: [
    { code: 6000; name: "InvalidVoteSide"; msg: "Invalid vote side." },
    { code: 6001; name: "InvalidProposalType"; msg: "Invalid proposal type." },
    {
      code: 6002;
    ...
    { code: 6006; name: "InvalidMaxOption"; msg: "Max option is invalid" },
    { code: 6007; name: "NotYesNoProposal"; msg: "Proposal is not YesNo." },
    { code: 6008; name: "NotOptionProposal"; msg: "Proposal is not Option." },
    {
      code: 6009;
